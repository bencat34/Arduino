...
Date: 2015/12/27 
*************************************************************/
int redPin = 2;   // R petal on RGB LED module connected to digital pin 11 
int greenPin = 3; // G petal on RGB LED module connected to digital pin 9 
int bluePin = 4;   // B petal on RGB LED module connected to digital pin 10 
void setup()    
{   
...
{    
    // Basic colors:  
    color(255, 100, 200); // turn the RGB LED red  
